...
class HomeViewModel: ObservableObject {
    ...
    func addSubscribers() {
        ...
        // subscription to searchText, coinData & sortOption, when any of them changes, maps & sinks the updates
        $searchText
        ...
        // subscription to allCoins (already filtered) & portfolioData, updates portfolioCoins and sorts if needed
        $allCoins
        ...
        // subscription to marketData & portfolioCoins, updates statistics array
    ...
    private func sortCoins(sort: SortOption, coins: inout [CoinModel]) {    // inout -> get and return the same array after being sorted
        switch sort {
        case .rank, .holdings:
    ...
    private func mapGlobalMarketData(marketDataModel: MarketDataModel?, portfolioCoins: [CoinModel]) -> [StatisticModel] {
        ...
        let portfolioValue = portfolioCoins
            ...
            .reduce(0, +)   // add all items from map and create a unique one [Double] -> Double
